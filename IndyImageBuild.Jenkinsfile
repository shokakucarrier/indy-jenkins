      ...
      steps{
        script{
          openshift.withCluster(){
            env.TARBALL_URL = "${GITHUB_URL}/release/indy-launcher-${params.INDY_VERSION}-skinny.tar.gz"

            env.DATA_TARBALL_URL = "${GITHUB_URL}/release/indy-launcher-${params.INDY_VERSION}-data.tar.gz"
